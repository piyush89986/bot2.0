...
export default function UserSettings() {
    ...
    const { playMessageSend, playMessageReceive, playNotification } = useSoundEffectsWithSettings(notifications.sounds);
    ...
    useEffect(() => {
        try {
            ...
            if (savedSettings) {
                ...
                setNotifications(parsed.notifications || { messages: true, mentions: true, sounds: false });
                setPrivacy(parsed.privacy || { showStatus: true, readReceipts: true, lastSeen: "Everyone" });
            }
                    ...
                    <div className="bg-white rounded-2xl p-5 sm:p-6 shadow-sm space-y-7">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex justify-between items-center py-1">
                                    <div className="flex-1">
                                        <span className="text-sm text-gray-700 block">Sound effects</span>
                                        <span className="text-xs text-gray-500">Play sound when sending/receiving messages</span>
                                    </div>
                                ...
                                {notifications.sounds && (
                                    <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                                        <p className="text-xs text-blue-700 font-medium mb-2">Test Sounds</p>
                        ...
                        <section>
                            ...
                            <div className="space-y-3">
                                ...
                                <div>
                                    <label className="block text-sm text-gray-700 mb-1.5">Last seen visibility</label>
                                    <select
                            ...
                            {deleteConfirm ? (
                                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                                    <p className="text-sm text-red-800 font-medium mb-4">
                                        Are you sure? This action cannot be undone. Your account and all data will be permanently deleted.
                                    </p>
