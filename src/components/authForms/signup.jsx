    ...
    return (
        <div className="w-full md:w-1/2 p-6 md:p-8 bg-slate-900/95 text-slate-100 flex flex-col justify-center">
            <div className="mb-6">
                ...
                <p className="text-sm text-slate-400 mt-1">Join ChatSphere and connect with your world</p>
            </div>
            ...
            <form onSubmit={handleSubmit(handleSignup)} className="space-y-4">
                ...
                <div>
                    ...
                    {errors.user_name && <p className="text-xs text-rose-400 mt-1 font-medium">{errors.user_name.message}</p>}
                </div>
